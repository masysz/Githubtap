  ...
  <div className="bg-[#6b0003] text-[#fff] text-[12px] font-extrabold text-center p-2 rounded-[10px] shadow-lg shadow-white/50">
    Booster per tap:<br /> +{tapValue.value * 5}
            ...
            <div className="w-full flex justify-center items-center relative">
              <div className="bg-[#cc0000] blur-[50px] absolute w-[200px] h-[220px] rounded-full mb-[300px]"></div>
              <div className={`${tapGuru ? 'block' : 'hidden'} pyro`}>
                <div className="before"></div>
                <div className="after"></div>
              </div>
              <div className="w-[400px] h-[400px] relative flex items-center justify-center mb-[300px]">
                <img
                  src="/lihgt.gif"
                  alt="err"
