...
const Plutos = () => {
  ...
  <div className="bg-[#606067] text-[#fff] text-[12px] font-extrabold text-center p-2 mr-2 rounded-[10px]">
  Welcome<br />{name}
  </div>
  <div className="bg-[#606067] text-[#fff] text-[12px] font-extrabold text-center p-2 mr-2 rounded-[10px]">
    Earn per tap:<br /> +{tapValue.value}
  </div>
  <div className="bg-[#606067] text-[#fff] text-[12px] font-extrabold text-center p-2 rounded-[10px]">
