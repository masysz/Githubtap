...
const Ref = () => {
  ...
  const formattedCount = useMemo(() => {
    return new Intl.NumberFormat().format(count).replace(/,/g, " ");
  }, [count]);
      ...
      {loading ? (
        ...
        <Animate>
          <div className="w-full justify-center flex-col space-y-3 px-5">
            ...
            <ReferralList filteredUsers={filteredUsers} />
...
const InviteLink = ({ idme, copied, copyToClipboard }) => (
...
const ReferralList = ({ filteredUsers }) => (
