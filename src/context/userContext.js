...
export const UserProvider = ({ children }) => {
  ...
  const updateUserLevel = async (userId, newTapBalance) => {
    ...
    if (newTapBalance >= 500000 && newTapBalance < 1000000) {
      ...
      newLevel = { id: 7, name: "Silver Old Ape", imgUrl: "/silveroldape.webp", imgTap: "/coin-7.webp", imgBoost: "/coins-7.webp" };
    } else if (newTapBalance >= 50000000 && newTapBalance < 100000000) {
      newLevel = { id: 8, name: "Green Old Ape", imgUrl: "/greenoldape.webp", imgTap: "/coin-8.webp", imgBoost: "/coins-8.webp" };
    } else if (newTapBalance >= 100000000 && newTapBalance < 1000000000) {
      newLevel = { id: 9, name: "Golden Old Ape", imgUrl: "/goldenoldape.webp", imgTap: "/coin-9.webp", imgBoost: "/coins-9.webp" };
